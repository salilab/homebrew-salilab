...
class Mdt < Formula
  ...
  def install
    ...
    if build.with? "python@3.12"
      python_version = Language::Python.major_minor_version Formula["python@3.12"].opt_bin/"python3.12"
      python_framework = Formula["python@3.12"].opt_prefix/"Frameworks/Python.framework/Versions/#{python_version}"
      py3_binary = Formula["python@3.12"].opt_prefix/"bin/python3.12"
